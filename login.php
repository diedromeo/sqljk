...
$password = ""; // Default for XAMPP (empty by default)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $showGif = "https://i.pinimg.com/originals/d6/84/00/d684004802d36c8f729b84bfcce4260a.gif"; // GIF for failed login
    }
...
<head>
    ...
    <style>
        ...
        .background-image {
            ...
            width: 100%;
            height: 100%;
            background: url('https://64.media.tumblr.com/a66359fd99917ba007f559d247d6908a/90f45168b5f13cb8-cb/s1280x1920/ab69ec52df7c75f466b2a2adcc5539df87982554.jpg') no-repeat center center fixed;
    ...
    <div class="container">
        <div class="frame">
            ...
            <?php if (!empty($flag)) : ?>
                ...
                <img src="https://i.makeagif.com/media/3-24-2019/tI6A7u.gif" alt="Success GIF" class="gif">
            <?php endif; ?>
